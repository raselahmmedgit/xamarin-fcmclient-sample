        ...
        private static bool TryHandleHttpExceptionByStatusCode(HttpExceptionContext context, out Exception generatedException)
        {
            ...
            switch (statusCode)
            {
                ...
                case HttpStatusCode.UpgradeRequired:
                    new UpdateRequiredException(context.ResponseError, context.ResponseError?.ErrorMessage);
                    break;
                case HttpStatusCode.ServiceUnavailable:
                    new MaintenanceResponseException(context.ResponseError, context.ResponseError?.ErrorMessage);
                    break;
                case HttpStatusCode.Unauthorized:
                    new UnauthorizedResponseException(context.ResponseError, context.ResponseError?.ErrorMessage);
                    break;
                default:
                    break;
            }
